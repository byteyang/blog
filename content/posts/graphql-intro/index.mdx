...
![graphql.png](https://i.loli.net/2019/01/21/5c44e5d847a84.png)
...
![](https://cdn-images-1.medium.com/max/1600/1*gLgBpni39kqad9C4QDOCVQ.png)
...
![](http://image.3001.net/images/20180910/1536549610_5b95e2ea4e7c9.png)
...
![](http://tuchuang.fate.ink/20190222093711_sbJHGh_Screenshot.png)

#### N+1 查询

N+1 查询是指如果主表与关联表是 1 对 N 的关系，查询主表数据时，会通过 N 次查询查询关联表数据的情况，而实际上关联表的最佳查询次数只需 1 次。因此 N+1 查询会加重数据库的负载，影响性能。

![](http://tuchuang.fate.ink/20190222091953_4zO110_Screenshot.png)
...
![](https://user-gold-cdn.xitu.io/2019/1/21/1686e2735297a596)
...
![](http://tuchuang.fate.ink/20190222103136_tP7IcH_Screenshot.png)
